...
Let's get back to our `astropy` example from the previous episode; as this package depends on `numpy`, let's see how we can leverage Intel optimised Python (files under `2.intelpy/`).
