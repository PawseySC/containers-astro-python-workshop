...
```
$ srun singularity exec -e m_1.sif python3 hello-mpi4py.py
```
{: .bash}
...
```
$ srun singularity exec -e m_1.sif python3 osu_bw.py
```
{: .bash}
...
```
$ srun singularity exec -e m_1.sif bash -c 'unset LD_LIBRARY_PATH ; python3 osu_bw.py'
```
{: .bash}
