...
Now, let's have a look at a more articulated example: suppose we need a container image that is able to run MPI Python code, *i.e.* using the package `mpi4py` (files under `1.mpi.python/`).  
